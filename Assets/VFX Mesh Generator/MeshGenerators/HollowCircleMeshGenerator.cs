...
public class HollowCircleMeshGenerator: MeshGenerator
{
    [SerializeField] int _sides = 32;
    [SerializeField] float _innerRadius = 0.5f;
    ...
    {
        List<Vector3> outerVerts = GetCircumferencesVertices(_sides, _outerRadius);
        List<Vector3> innerVerts = GetCircumferencesVertices(_sides, _innerRadius);
